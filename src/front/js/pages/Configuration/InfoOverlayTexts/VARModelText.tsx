...
const VARModelText = () => {
  return (
    <div>
      ...
      (AutoRegressive) model, extending it to predict multivariate time series.
      It assumes that each variable in the multivariate time series influences
      and is influenced by the others. The parameter 𝑝 p indicates the number of
      lagged observations of each variable which influence the current
      observation.
      <br />
      ...
      differences of the data in order to make them stationary, and then proceed
      with fit a VAR model.
